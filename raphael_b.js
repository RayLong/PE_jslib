...
window.Raphael = (function() {
    var a = /[, ]+/,
        aK = /^(circle|rect|path|ellipse|text|image)$/,
        J = document,
        aq = window,
        l = {
            was: "Raphael" in aq,
        ...
        al = function() {
            if (al.is(arguments[0], "array")) {
                var d = arguments[0],
                    e = w[aS](al, d.splice(0, 3 + al.is(d[0], aj))),
                    S = e.set();
        ...
        ak = " ",
        z = "split",
        D = "click dblclick mousedown mousemove mouseout mouseover mouseup" [z](ak),
        O = "hasOwnProperty",
        av = "join",
        m = "length",
        aU = "prototype",
        aV = String[aU].toLowerCase,
        Z = Math,
        g = Z.max,
        aE = Z.min,
        aj = "number",
    ...
    function ah(E, e, d) {
        function i() {
            var R = Array[aU].slice.call(arguments, 0),
                aW = R[av]("\u25ba"),
                S = i.cache = i.cache || {},
                aX = i.count = i.count || [];
            if (S[O](aW)) {
    ...
    al.getRGB = ah(function(d) {
        ...
        if (d == "none") {
            ...
            hs: 1,
            rg: 1
        })[O](d.substring(0, 2)) || d.charAt() == "#") && (d = az(d));
    ...
    al.findDotsAtSegment = function(e, d, ba, a8, aW, R, aY, aX, a4) {
        var a2 = 1 - a4,
            a1 = aI(a2, 3) * e + aI(a2, 2) * 3 * a4 * ba + a2 * 3 * a4 * a4 * aW + aI(a4, 3) * aY,
            aZ = aI(a2, 3) * d + aI(a2, 2) * 3 * a4 * a8 + a2 * 3 * a4 * a4 * R + aI(a4, 3) * aX,
            a6 = e + 2 * a4 * (ba - e) + a4 * a4 * (aW - 2 * ba + e),
            a5 = d + 2 * a4 * (a8 - d) + a4 * a4 * (R - 2 * a8 + d),
            a9 = ba + 2 * a4 * (aW - ba) + a4 * a4 * (aY - 2 * aW + ba),
            a7 = a8 + 2 * a4 * (R - a8) + a4 * a4 * (aX - 2 * R + a8),
            a3 = (1 - a4) * e + a4 * ba,
            a0 = (1 - a4) * d + a4 * a8,
            E = (1 - a4) * aW + a4 * aY,
            i = (1 - a4) * R + a4 * aX,
            S = (90 - Z.atan((a6 - a9) / (a5 - a7)) * 180 / Z.PI) % 360;
        return {
            x: a1,
            y: aZ,
            m: {
    ...
    var Q = ah(function(a1) {
        ...
        I = function(a5, bz, be, bc, a6, a0, S, a4, by, a7) {
            var R = Z.PI,
                ...
                d = R / 180 * (+a6 || 0),
                bi = [],
                bf, bv = ah(function(bA, bD, i) {
                    var bC = bA * Z.cos(i) - bD * Z.sin(i),
                        bB = bA * Z.sin(i) + bD * Z.cos(i);
                    return {
                        x: bC,
                        y: bB
                    };
            ...
            if (!a7) {
                ...
                var E = be * be,
                    bn = bc * bc,
                    bp = (a0 == S ? -1 : 1) * Z.sqrt(Z.abs((E * bn - E * bj * bj - bn * bk * bk) / (E * bj * bj + bn * bk * bk))),
                    a9 = bp * be * bj / bc + (a5 + a4) / 2,
                    a8 = bp * -bc * bk / be + (bz + by) / 2,
                    aZ = Z.asin(((bz - a8) / bc).toFixed(7)),
                    aY = Z.asin(((by - a8) / bc).toFixed(7));
                aZ = a5 < a9 ? R - aZ : aZ;
                aY = a4 < a9 ? R - aY : aY;
                aZ < 0 && (aZ = R * 2 + aZ);
                aY < 0 && (aY = R * 2 + aY);
            ...
            var aX = Z.cos(aZ),
                ...
                bm = 4 / 3 * bc * bl,
                bu = [a5, bz],
                bt = [a5 + bo * bx, bz - bm * aX],
                bs = [a4 + bo * bw, by - bm * aW],
                bq = [a4, by];
            bt[0] = 2 * bu[0] - bt[0];
            bt[1] = 2 * bu[1] - bt[1];
            if (a7) {
        ...
        K = function(e, d, E, i, aY, aX, aW, S, aZ) {
            var R = 1 - aZ;
            return {
                x: aI(R, 3) * e + aI(R, 2) * 3 * aZ * E + R * 3 * aZ * aZ * aY + aI(aZ, 3) * aW,
                y: aI(R, 3) * d + aI(R, 2) * 3 * aZ * i + R * 3 * aZ * aZ * aX + aI(aZ, 3) * S
            };
        },
        ay = ah(function(i, d, R, E, a5, a4, a1, aY) {
            var a3 = (a5 - 2 * R + i) - (a1 - 2 * a5 + R),
                a0 = 2 * (R - i) - 2 * (a5 - R),
                aX = i - R,
    ...
    if (al.svg) {
        ...
        var b = function(E, a3, d) {
                ...
                if (a0 == "linear") {
                    ...
                    var R = [0, 0, Z.cos(aW * Z.PI / 180), Z.sin(aW * Z.PI / 180)],
                        a2 = 1 / (g(Z.abs(R[2]), Z.abs(R[3])) || 1);
                    R[2] *= a2;
                    R[3] *= a2;
                    if (R[2] < 0) {
                        R[0] = -R[2];
                ...
                for (var aY = 0, a4 = aZ[m]; aY < a4; aY++) {
                    var a1 = aF("stop");
                    aF(a1, {
                        offset: aZ[aY].offset ? aZ[aY].offset : !aY ? "0%" : "100%",
                        "stop-color": aZ[aY].color || "#fff"
                    });
                    e[aH](a1);
                }
                aF(E, {
        ...
        var L = function(e) {
                var d = e.getBBox();
                aF(e.pattern, {
                    patternTransform: al.format("translate({0},{1})", d.x, d.y)
                });
            };
        var Y = function(a2, bb) {
                var a5 = {
                    ...
                    S = function(bi, bh) {
                        bh = a5[aV.call(bh)];
                        if (bh) {
                            var bf = bi.attrs["stroke-width"] || "1",
                                bd = {
                                    round: bf,
                                    square: bf,
                                    butt: 0
                                }[bi.attrs["stroke-linecap"] || bb["stroke-linecap"]] || 0,
                                bg = [];
                            var be = bh[m];
                            while (be--) {
                    ...
                    if (bb[O](a6)) {
                        ...
                        case "fill":
                            ...
                            if (!al.getRGB(a4).error) {
                                delete bb.gradient;
                                delete a3.gradient;
                                !al.is(a3.opacity, "undefined") && al.is(bb.opacity, "undefined") && aF(a7, {
                                    opacity: a3.opacity
                                });
                                !al.is(a3["fill-opacity"], "undefined") && al.is(bb["fill-opacity"], "undefined") && aF(a7, {
                                    "fill-opacity": a3["fill-opacity"]
                                });
                            } else {
                                if ((({
                                    circle: 1,
                                    ellipse: 1
                                })[O](a2.type) || (a4 + ap).charAt() != "r") && b(a7, a4, a2.paper)) {
                                    a3.gradient = a4;
                                    a3.fill = "none";
                                    break;
                                }
        ...
        var C = function(d, R) {
                ...
                var aZ = d.attrs,
                    e = d.node,
                    a1 = e.firstChild ? F(J.defaultView.getComputedStyle(e.firstChild, ap).getPropertyValue("font-size"), 10) : 10;
                if (R[O]("text")) {
                    aZ.text = R.text;
                    while (e.firstChild) {
        ...
        au[aU].rotate = function(e, d, E) {
            ...
            if (this._.rt.deg) {
                ...
                this.clip && aF(this.clip, {
                    transform: al.format("rotate({0} {1} {2})", -this._.rt.deg, d, E)
                });
            } else {
            ...
            aF(this.node, {
                transform: this.transformations[av](ak)
            });
            return this;
        };
        au[aU].hide = function() {
        ...
        aP[aU].clear = function() {
            ...
            (this.desc = aF("desc"))[aH](J.createTextNode("Created with Rapha\xebl"));
            d[aH](this.desc);
            d[aH](this.defs = aF("defs"));
        };
    ...
    if (al.vml) {
        ...
        var Y = function(aZ, a4) {
                ...
                if ("clip-rect" in a4) {
                    ...
                    if (d[m] == 4) {
                        d[2] = +d[2] + (+d[0]);
                        d[3] = +d[3] + (+d[1]);
                        var aY = a2.clipRect || J.createElement("div"),
                            a8 = aY.style,
                            S = a2.parentNode;
                ...
                if (a4.opacity != null || a4["stroke-width"] != null || a4.fill != null || a4.stroke != null || a4["stroke-width"] != null || a4["stroke-opacity"] != null || a4["fill-opacity"] != null || a4["stroke-dasharray"] != null || a4["stroke-miterlimit"] != null || a4["stroke-linejoin"] != null || a4["stroke-linecap"] != null) {
                    a2 = aZ.shape || a2;
                    var a3 = (a2.getElementsByTagName("fill") && a2.getElementsByTagName("fill")[0]),
                        a6 = false;
                    !a3 && (a6 = a3 = af("fill"));
                    ...
                    if (a3.on && a4.fill) {
                        ...
                        if (i) {
                            ...
                            a3.src = ap;
                            a3.type = "solid";
                            if (al.getRGB(a4.fill).error && (a9.type in {
                                circle: 1,
                                ellipse: 1
                            } || (a4.fill + ap).charAt() != "r") && b(a9, a4.fill)) {
                                a5.fill = "none";
                                a5.gradient = a4.fill;
                            }
                        }
                    ...
                    a6 && a2[aH](a3);
                    var R = (a2.getElementsByTagName("stroke") && a2.getElementsByTagName("stroke")[0]),
                        a7 = false;
                    !R && (a7 = R = af("stroke"));
                    ...
                    var e = ((+a5["stroke-opacity"] + 1 || 2) - 1) * ((+a5.opacity + 1 || 2) - 1),
                        a0 = (U(a4["stroke-width"]) || 1) * 0.75;
                    e < 0 && (e = 0);
                    e > 1 && (e = 1);
        ...
        var b = function(d, aX) {
                d.attrs = d.attrs || {};
                var aY = d.attrs,
                    a0 = d.node.getElementsByTagName("fill"),
                    S = "linear",
                    aW = ".5 .5";
                d.attrs.gradient = aX;
        ...
        au[aU].attr = function() {
            ...
            if (S) {
                ...
                if (S.gradient && (({
                    circle: 1,
                    ellipse: 1
                })[O](this.type) || (S.gradient + ap).charAt() != "r")) {
                    b(this, S.gradient);
        ...
        var w = function() {
                ...
                var R = new aP,
                    S = R.canvas = J.createElement("div"),
                    E = S.style;
                e = e || 512;
                aY = aY || 342;
                e == +e && (e += "px");
                ...
                R.span.style.cssText = "position:absolute;left:-9999px;top:-9999px;padding:0;margin:0;line-height:1;display:inline;";
                S[aH](R.span);
            ...
            au[aU][d] = function(e) {
                if (al.is(e, "function")) {
                    ...
                    this.events.push({
                        name: d,
                        f: e,
                        unbind: ac(this.shape || this.node, d, e, this)
                    });
                }
                return this;
            };
    ...
    au[aU].scale = function(a2, a1, E, e) {
        ...
        if (a2 != 0) {
            ...
            case "rect":
            case "image":
                var aY = bi.width * aZ * bh,
                    bc = bi.height * aW * bg;
                this.attr({
                    height: newh,
                    r: bi.r * aE(aZ * bh, aW * bg),
                    width: aY,
                    x: bk - aY / 2,
                    y: bj - newh / 2
                });
            ...
            for (var R in e.glyphs) {
                if (e.glyphs[O](R)) {
                    ...
                    E.glyphs[R] = {
                        w: S.w,
                        k: {},
                        d: S.d && "M" + S.d[aL](/[mlcxtrv]/g, function(aX) {
                            return {
                                l: "L",
                                c: "C",
                                x: "z",
    ...
    aP[aU].print = function(R, E, d, aX, aY, a7) {
        ...
        if (aX) {
            ...
            var e = aX.face.bbox.split(a),
                aW = +e[0],
                aZ = +e[1] + (a7 == "baseline" ? e[3] - e[1] + (+aX.face.descent) : (e[3] - e[1]) / 2);
            for (var a2 = 0, S = a6[m]; a2 < S; a2++) {
                var a1 = a2 && aX.glyphs[a6[a2 - 1]] || {},
                    a5 = aX.glyphs[a6[a2]];
                a4 += a2 ? (a1.w || aX.w) + (a1.k && a1.k[a6[a2]] || 0) : 0;
                a5 && a5.d && a3[f](this.path(a5.d).attr({
                    fill: "#000",
                    stroke: "none",
                    translation: [a4, 0]
                }));
    ...
    al.format = function(i) {
        var e = al.is(arguments[1], "array") ? [0][aO](arguments[1]) : arguments,
            d = /\{(\d+)\}/g;
